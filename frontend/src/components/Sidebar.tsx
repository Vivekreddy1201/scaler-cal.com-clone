...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-56 flex-col border-r border-gray-200 bg-gray-50 px-4 py-6 dark:border-zinc-800 dark:bg-gradient-to-b dark:from-[#222222] dark:to-[#111111]">
